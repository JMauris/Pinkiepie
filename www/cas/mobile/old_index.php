                ...
                <tr>
                    ...
                    <td class="tdIndex">
                        <a href="valrando.php" rel="external">
                            <img src="../pictures/logo.gif" alt="<?php echo $traductions['infos_CAS'][$_SESSION['langue']] ?>"/>
                            <p><?php echo $traductions['infos_CAS'][$_SESSION['langue']] ?></p>
                        </a>
                    </td>
                </tr>
                <?php
                ...
                <tr>
                    <td colspan=2 class="tdIndex">
                        <a href="connexion.php" rel="external">
                            <img src="../pictures/icons/lock.png" alt="<?php echo $traductions['monCAS'][$_SESSION['langue']] ?>"/>
                            <p><?php echo $traductions['monCAS'][$_SESSION['langue']] ?></p>
                        </a><br/>
                    </td>
                </tr>
                <?php
