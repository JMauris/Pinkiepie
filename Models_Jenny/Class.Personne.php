...
class Personne{
	  ...
	  public function __construct($id=null, $firstname, $lastname, $email, $password, $idxLangue, $estActif, $numMember, $role, $portable, $phone, $adresse, $localite, $npa, $idxAbonnement){
